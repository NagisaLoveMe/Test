 ...
 * Author:
 * -------
 *  Chia-Ling Ko(mtk02711)   EMI auto generator V8.267
 *
 *   Memory Device database last modified on 2014/7/18
 *
 *============================================================================
 *             HISTORY
 ...
 *******************************************************************************/
#define REGION_INFO_LAYOUT    {0x8000, 21}, \
   {0x1000, 8},

#ifndef __NVRAM_BACKUP_PARTITION__
#define DISK0_REGION_INFO_LAYOUT    {0x8000, 21}, \
   {0x1000, 8},

#define DISK1_REGION_INFO_LAYOUT    {0x8000, 21}, \
   {0x1000, 8},
#endif

#define ENTIRE_DISK_REGION_INFO_LAYOUT    {0x8000, 127}, \
   {0x1000, 8},
...
#define BANK_INFO_LAYOUT    { 0xB0000, 1 }, \
