...
typedef oa_int32 oa_gpt_handle;
...
typedef void (* oa_bt_spp_receive_data_fp)(void*, oa_uint32);
...
typedef enum {
   ...
   OA_UART1 = 0,
   OA_UART2,
   OA_UART_AT,  /*virtual port for AT command */    /*vuart_port_at*/
   OA_UART_USB1 = 0x05, /*Note : now only use for g_oa_tst_port!!!*/    /*uart_port_usb*/
   OA_UART_USB2 = 0x06,

   OA_UART_NUM, /*for physical uart port num*/
...
typedef enum{
    ...
    OA_TIMER_ID_USB1_READ_DELAY,  //system reserved,do not use and delete
	OA_TIMER_ID_USB2_READ_DELAY,
...
typedef enum
{
   OA_DCL_I2C_OWNER_1=0, /*DCL_I2C_OWNER_CAMERA*/
   OA_DCL_I2C_OWNER_2, /*DCL_I2C_OWNER_FM*/
   OA_DCL_I2C_OWNER_3,  /*DCL_I2C_OWNER_TP*/
   OA_DCL_I2C_OWNER_4,  /*DCL_I2C_OWNER_MS*/
   OA_DCL_I2C_OWNER_5,  /*DCL_I2C_OWNER_AF*/
   OA_DCL_I2C_OWNER_6,  /*DCL_I2C_OWNER_CAMERA_EEPROM*/
   OA_DCL_I2C_OWNER_7,  /*DCL_I2C_OWNER_MUIC*/
   OA_DCL_I2C_OWNER_8,  /*DCL_I2C_OWNER_MATV*/
   OA_DCL_I2C_OWNER_9,  /*DCL_I2C_OWNER_PS*//*pressure sensor*/  
   OA_DCL_I2C_OWNER_10,  /*DCL_I2C_OWNER_EP*/ /*EEPROM*/

   OA_DCL_I2C_OWNER_MAX /*notiry:do not modify the value of owner number!!!*/
}oa_dcl_i2c_owner;
...
typedef oa_uint32  oa_dcl_event;
typedef enum
{
   OA_EVENT_NULL = 0,
   
   OA_GPT_EVENTS_START = OA_EVENT_NULL,
   OA_GPIO_EVENTS_START = 0x100,

   OA_RTC_EVENTS_START = 0x400,
   OA_EVENT_HGPT_TIMEOUT = 0x1,
   OA_ADC_EVENTS_START = 0x600,

   OA_I2C_EVENTS_START = 0x700,
   OA_F32K_CLK_EVENTS_START = 0x1300,
      
   OA_EVENT_END
} oa_dcl_event_t;

typedef oa_uint32 oa_dcl_flags;
typedef enum
{
   OA_FLAGS_NONE = 0,
   OA_FLAGS_END
...
typedef enum
{
   ...
   OA_HGPT_CMD_START, 
   OA_HGPT_CMD_STOP, 
   OA_HGPT_CMD_BUSYWAIT,
//   OA_HGPT_CMD_GPT_STATUS,
   OA_FHGPT_CMD_START, 
   OA_FHGPT_CMD_STOP, 
   OA_FHGPT_CMD_RETURN_COUNT,
   OA_FHGPT_CMD_LOCK
} oa_hgpt_cmt_t;
...
typedef struct
{
   oa_uint32   u4Clock; // for HGPT_CLK_T enum
} oa_hgpt_ctrl_clk_t;

/* For HGPT_CMD_RESET command. */
typedef struct
{
   oa_uint16   u2CountValue;
   oa_int32     fgAutoReload;
} oa_hgpt_ctrl_reset_t;

typedef  union
{
   oa_hgpt_ctrl_clk_t         rHGPTClk; 
   oa_hgpt_ctrl_reset_t      rHGPTReset; 
   oa_uint16       u2RetCount;
   oa_uint32       u2RetCount_32bit;
   oa_uint16	      uBusyWaitCount;
   oa_int32		  ulock;
} oa_hgpt_ctrl;

typedef void (*oa_pfn_dcl_callback)(oa_dcl_event event);
